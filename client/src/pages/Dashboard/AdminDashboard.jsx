...
const AdminDashboard = () => {
  ...
  {/* Sidebar */}
  <aside className="w-full md:w-64 bg-gray-800 p-6 space-y-6">
    <h1 className="text-xl font-bold text-cyan-400 text-center">Admin Panel</h1>
    <nav className="space-y-4 mt-4 flex md:block justify-around md:justify-start">
      <a href="#" className="flex items-center gap-2 text-cyan-400 hover:text-white">
        <FaUsers /> Users
      </a>
      <Link to="/withdraw-requests" className="flex items-center gap-2 text-cyan-400 hover:text-white">
        <BiMoneyWithdraw /> Withdraw Requests
      </Link>
      <Link to="/deposit-requests" className="flex items-center gap-2 text-cyan-400 hover:text-white">
        <FaWallet /> Deposits
      </Link>
    </nav>
  </aside>
